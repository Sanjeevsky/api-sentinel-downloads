...
- Collections, environments, and request history for local-first developer workflows
...
- Initial public release placeholder for first release notes
- Replace these entries with exact release details before publishing
